...
export const workData = [
  {
    ...
    description:
      "AI-powered career planning platform that generates personalized, adaptive learning roadmaps based on your current skills and target role.",
    tech: ["Next.js", "MongoDB", "JWT Auth", "Gemini AI"],
    bgImage: "/work-3.png",
    liveLink: "https://career-growth-blush.vercel.app/",
    githubLink: "https://github.com/Ahmad-khan-1/career-growth",
  },
  {
    title: "TaskFlow",
    description:
      "Production-ready to-do & task management app with authentication and persistent data.",
  ...
  },
  {
    ...
    description:
      "Animated gym landing page focused on smooth motion design and responsive layout.",
